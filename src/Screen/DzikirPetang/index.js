  ...
  state = {
    data: [
      ...
      },
      {
        id: 5,
        lafaldz:
          'أَعُوذُ بِاللَّهِ مِنَ الشَّيْطَانِ الرَّجِيمِ قُلْ أَعُوذُ بِرَبِّ النَّاسِ مَلِكِ النَّاسِ إِلَهِ النَّاسِ مِن شَرِّ الْوَسْوَاسِ الْخَنَّاسِ الَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاسِ مِنَ الْجِنَّةِ وَ النَّاسِ',
        terjemahan:
      ...
      },
      {
        ...
        terjemahan:
          '“Kami telah memasuki waktu Petang dan kerajaan hanya milik Allah, segala puji bagi Allah. Tidak ada ilah (yang berhak disembah) kecuali Allah semata, tiada sekutu bagi-Nya. Milik Allah kerajaan dan bagi-Nya pujian. Dia-lah Yang Mahakuasa atas segala sesuatu. Wahai Rabbku, aku mohon kepada-Mu kebaikan di malam ini dan kebaikan sesudahnya. Aku berlindung kepada-Mu dari kejahatan malam ini dan kejahatan sesudahnya. Wahai Rabbku, aku berlindung kepada-Mu dari kemalasan dan kejelekan di hari tua. Wahai Rabbku, aku berlindung kepada-Mu dari siksaan di neraka dan siksaan di alam kubur.” (Dibaca 1 x)',
      },
      {
        id: 7,
        lafaldz:
        ...
        terjemahan:
          '“Ya Allah, dengan rahmat dan pertolongan-Mu kami memasuki waktu Petang, dan dengan rahmat dan pertolongan-Mu kami memasuki waktu Pagi. Dengan rahmat dan pertolongan-Mu kami hidup dan dengan kehendak-Mu kami mati. Dan kepada-Mu kebangkitan (bagi semua makhluk).” (Dibaca 1 x)[4]',
      },
      {
        id: 8,
        lafaldz:
      ...
      },
      {
        ...
        terjemahan:
          '“Di waktu Petang kami memegang agama Islam, kalimat ikhlas (kalimat syahadat), agama Nabi kami Muhammad shallallahu ‘alaihi wa sallam, dan agama bapak kami Ibrahim, yang berdiri di atas jalan yang lurus, muslim dan tidak tergolong orang-orang musyrik.” (Dibaca 1 x di Petang hari saja)[12]',
      },
      {
        id: 16,
      ...
      },
      {
        ...
        terjemahan:
          '“Maha Suci Allah, aku memujiNya sebanyak makhluk-Nya, sejauh kerelaan-Nya, seberat timbangan ‘Arsy-Nya dan sebanyak tinta tulisan kalimat-Nya.” (Dibaca 3 x di waktu Petang saja)',
      },
      {
        id: 20,
        lafaldz:
    ...
    return (
      <View style={{flex: 1}}>
        <View style={{justifyContent: 'center', alignItems: 'center'}}>
          <Text style={{fontSize: 30}}>Dzikir Petang</Text>
        </View>
        <ScrollView>
          {this.state.data.map((value, key) => {
            const datakey = value.id;
            if (datakey % 2 == 0) {
              return (
                <View
                  style={{
                  ...
                  key={key}>
                  <View>
                    <Text>{value.lafaldz}</Text>
                  </View>
                  <View>
                    <Text>{value.terjemahan}</Text>
                  </View>
                </View>
              );
            } else if (datakey % 2 == 1) {
